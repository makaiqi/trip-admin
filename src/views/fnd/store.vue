      ...
      <el-card>
        ...
        <div class="base-block-container">
          <el-form ref="formSearch" :inline="true" v-model="tableList.query">
            <el-form-item>
              <el-input clearable v-model="tableList.query.search" placeholder="请输入景区门店名称"></el-input>
            </el-form-item>
    ...
    <div class="base-block-right">
      <el-card>
        <el-tabs type="border-card">
          <el-tab-pane label="添加门店">
            <el-form label-position="top" ref="form" :model="form" :rules="ruleForm" label-width="80px">
              <el-form-item label="门店名称" prop="storeName">
                <el-input clearable v-model="form.storeName" placeholder="门店名称"></el-input>
              </el-form-item>
              <el-form-item label="品牌" prop="brandName">
                <zzu-brand-select v-model="form.tblBrandId" placeholder="品牌"></zzu-brand-select>
              </el-form-item>
               <el-form-item label="主图" prop="tblAssetId">
                <zzu-upload v-model="tblAssetId" list-type="picture-card" :limit="1"></zzu-upload>
                <div style="color:red">请上传尺寸为670px宽 387px高的图片（宽高比为1.72）</div>
              </el-form-item>
              <el-form-item label="电话" prop="tel">
                <el-input clearable v-model="form.tel" placeholder="电话"></el-input>
              </el-form-item>
              <el-form-item label="营业时段" prop="openTime">
                <el-input clearable v-model="form.openTime" placeholder="营业时段"></el-input>
              </el-form-item>
             
              <el-form-item label="门店简述" prop="summary">
                <el-input clearable v-model="form.summary" placeholder="门店简述" autosize type="textarea"></el-input>
              </el-form-item>
              <el-form-item label="门店描述" prop="content">
                <el-input clearable v-model="form.content" placeholder="门店描述" autosize type="textarea"></el-input>
              </el-form-item>
              <el-form-item>
  ...
  export default {
    ...
    watch: {
      'tableList.query': {
       ...
       tblAssetId(newValue, oldValue) {
          
      if (newValue.length > 0) {
        this.form.tblAssetId = newValue[0].id;
      } else {
        this.form.tblAssetId = "";
      }
    },
        ...
        handler(n, o) {
          if (n) {
            this.cfg.tabActiveName = 'form'
             if(this.form.tblAssetId){
               this.tblAssetId = [{ id: this.form.assetDomain.id, url: this.form.assetDomain.url }];
              }else{
                 this.tblAssetId  = [];
              } 
            // console.log(this.form,"eee")
            ...
            if (this.form.pointDomain) { 
              ...
              if(this.pointForm.voiceAssetId && this.pointForm.voiceUrl){
                ...
                console.log(this.pointForm.voiceUrl,'this.pointForm.voiceUrl');
              }else{
                this.vo.radio =[];
              }
    ...
    methods: {
      ...
      saveOrUpdate() {
        ...
        this.$http.post('biz/Store/saveOrUpdate',
          this.form
        ).then(rs => {
      ...
      deleteData() {
        ...
        this.$confirm(`此操作将永久删除, 是否继续?`, '提示', {
          ...
          this.$http.post('biz/Store/remove',
            data
          ).then(rs => {
            if (rs.data.code == 0) {
              this.findPage();
