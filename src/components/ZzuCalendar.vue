<template>
  <div class="month-box" @mouseup="sendEvent" @mouseleave="sendEvent" @click.native="sendEvent" @click="sendEvent" :style="{width,height}">
    <div class="month-bar-box">
      ...
      <div class="month-bar-item center">
        ...
        <el-button type="warning" icon="el-icon-delete" class="remove-btn" @click="cancelAllDateChecked">清除选中状态
        </el-button>
      </div>
      <div class="month-bar-item">
